...
Bu repoda yer alan dosyalar, Yapay Zeka Sistemleri dersi kapsamında hazırlanan 2. proje ödevini (Senaryo 8) içermektedir. Projede amaç, Isparta il merkezinde belirlenen afet ve acil durum toplanma alanları arasında bir acil durum nakliye dronu için en uygun (toplam mesafesi en kısa) rotayı bulmaktır.
